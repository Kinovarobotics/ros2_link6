...
2. Clone this repository:
    ...
    ```bash
    git clone https://github.com/Kinovarobotics/ros2_link6.git
    ```
...
```bash
ros2 launch link6_bringup link6_sim.launch.py gripper:=robotiq_2f_85 calibration_file:=/path/to/your_robot_calibration.yaml
```
