...
enum ErrorCodes : int {
  ...
  ERROR_DEVICE = 3,
  ERROR_INTERNAL = 4,
  ErrorCodes_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ErrorCodes_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ErrorCodes_IsValid(int value);
constexpr ErrorCodes ErrorCodes_MIN = ERROR_NONE;
constexpr ErrorCodes ErrorCodes_MAX = ERROR_INTERNAL;
constexpr int ErrorCodes_ARRAYSIZE = ErrorCodes_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ErrorCodes_descriptor();
template<typename T>
inline const std::string& ErrorCodes_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ErrorCodes>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ErrorCodes_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ErrorCodes_descriptor(), enum_t_value);
}
...
enum SubErrorCodes : int {
  ...
  COLLISION_DETECTED = 142,
  WRONG_MODE = 143,
  SubErrorCodes_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SubErrorCodes_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool SubErrorCodes_IsValid(int value);
constexpr SubErrorCodes SubErrorCodes_MIN = SUB_ERROR_NONE;
constexpr SubErrorCodes SubErrorCodes_MAX = WRONG_MODE;
constexpr int SubErrorCodes_ARRAYSIZE = SubErrorCodes_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SubErrorCodes_descriptor();
template<typename T>
inline const std::string& SubErrorCodes_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SubErrorCodes>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SubErrorCodes_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SubErrorCodes_descriptor(), enum_t_value);
}
inline bool SubErrorCodes_Parse(
    const std::string& name, SubErrorCodes* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SubErrorCodes>(
...
template <> struct is_proto_enum< ::Kinova::Api::ErrorCodes> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Kinova::Api::ErrorCodes>() {
  return ::Kinova::Api::ErrorCodes_descriptor();
}
template <> struct is_proto_enum< ::Kinova::Api::SubErrorCodes> : ::std::true_type {};
template <>
