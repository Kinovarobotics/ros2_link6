...
def generate_move_group_launch(moveit_config):
    ...
    # use_sim_time should be set to True when running in simulation
    ld.add_action(DeclareBooleanLaunchArg("use_sim_time", default_value=False))

    # weather or not to run rviz
...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("link6", package_name="link6_moveit_config").to_moveit_configs()
